class Explosive {
  constructor(
    ...
    this.damage = damage;
    this.id = id;
    this.img = `../assets/explosives/${img}.png`;
...
explosives[0] = new Explosive(
  ...
  0,
  "explosive.timed",
  [{ metalFragments: 200 }, { cloth: 20 }, { techTrash: 2 }, { animalFat: 45 }],
  3,
  2550,
  2200,
  3000,
...
explosives[1] = new Explosive(
  ...
  1,
  "ammo.rocket.basic",
  [{ metalFragments: 100 }, { cloth: 20 }, { metalPipe: 2 }, { animalFat: 24 }],
  3,
  2700,
  1400,
  1950,
...
explosives[2] = new Explosive(
  ...
  2,
  "explosive.satchel",
  [{ metalFragments: 80 }, { cloth: 10 }, { rope: 1 }],
  1,
  840,
  480,
  720,
