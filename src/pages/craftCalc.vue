<template>
  <div
    class="container mx-auto d-flex flex-column justify-content-between"
    style="height: calc(100vh - 30px); align-items: normal"
  >
    <Language></Language>

    <div>
      <div class="row">
        <h1 class="text-center text-secondary text-info">{{ t('calculator for the raid') }}</h1>
      </div>
    ...
    <BModal v-model="modal" :title="t('choose the target')">
